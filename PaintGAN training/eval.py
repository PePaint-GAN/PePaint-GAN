...
if __name__ == "__main__":
    ...
    parser.add_argument('--end_iter', type=int, default=7)
    ...
    for epoch in [10000*i for i in range(args.start_iter, args.end_iter+1)]:
        ckpt = './train_results/Colonial_PaintGAN/models/%d.pth'%(epoch)
        ...
        dist = './train_results/Colonial_PaintGAN/eval_%d'%(epoch)
