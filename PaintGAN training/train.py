...
if __name__ == "__main__":
    ...
    parser.add_argument('--path', type=str, default='./datasets/150-shot-col/img', help='path of resource dataset, should be a folder that has one or many sub image folders inside')
    parser.add_argument('--cuda', type=int, default=0, help='index of gpu to use')
    parser.add_argument('--name', type=str, default='Colonial_PaintGAN', help='experiment name')
    parser.add_argument('--iter', type=int, default=70000, help='number of iterations')
